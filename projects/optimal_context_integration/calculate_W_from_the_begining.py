...
for i in range(0,18):
    ...
    for j in range(0,137):
        ...
        #Here we throw all negatives from the image_temp, "rectify" in the paper.
        image_with_negatives = image_temp[cord[0],cord[1]].T
        image_without_negatives = np.abs(np.multiply(image_with_negatives,image_with_negatives>0))
        temp.append(image_without_negatives)
